...
def main(input_filepath, output_filepath): #pragma no cover
    ...
    file_names = ['chroma-nnls_piano.csv', 'chroma-nnls_orchestra.csv', 'chroma-nnls_full.csv']
    datasets = make_datasets(glob_patterns, file_names, input_filepath, COL_NAMES)
...
def make_datasets(glob_patterns: list[str], file_names: list[str], input_filepath, columns: list[str]):
    ...
    for i, data in enumerate(datasets):
        ...
        # Numpy sets the dtype of the chroma columns as object because of the "piece" column
