    ...
    def test_one_step(self, data):
        ...
        expected = pd.DataFrame([
            {'piece': 'bach_2.mp3', 'time': 0, 'c1': 0.33, 'c2': 2.67, 'c3': 2.1, 'c4': 2.2, 
                'c5': 0.31, 'c6': 1.44, 'c7': 3.4, 'c8': 4.62, 'c9': 2.43, 'c10': 4.3, 'c11': 4.18, 'c12': 2.77},
            {'piece': 'vivaldi_1.mp3', 'time': 0, 'c1': 0, 'c2': 0.12, 'c3': 0.7, 'c4': 0.39, 
                'c5': 0.22, 'c6': 1.28, 'c7': 0.37, 'c8': 0.6, 'c9': 1.11, 'c10': -0.13, 'c11': 0.02, 'c12': -0.05}
        ])
    ...
    def test_two_steps(self, data):
        ...
        expected = pd.DataFrame([
            {'piece': 'bach_2.mp3', 'time': 0, 'c1': 0.01073170732, 'c2': 0.08682926829, 'c3': 0.06829268293, 'c4': 0.07154471545, 
                'c5': 0.01008130081, 'c6': 0.04682926829, 'c7': 0.1105691057, 'c8': 0.1502439024, 'c9': 0.07902439024, 
                'c10': 0.1398373984, 'c11': 0.1359349593, 'c12': 0.09008130081},
            {'piece': 'vivaldi_1.mp3', 'time': 0, 'c1': 0, 'c2': 0.02404809619, 'c3': 0.1402805611, 'c4': 0.07815631263, 
