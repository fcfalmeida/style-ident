...
class TestMeanAndStd:
    ...
    def data(scope='class'):
        df = pd.DataFrame([
            {'piece': 'bach_2.mp3', 'time': 0, 'ic1': 0.04, 'ic2': 0.33, 'ic3': 0},
            {'piece': 'bach_2.mp3', 'time': 0.1, 'ic1': 0.1, 'ic2': 0.28, 'ic3': 0},
            {'piece': 'bach_2.mp3', 'time': 0.1, 'ic1': 0.09, 'ic2': 0.06, 'ic3': 0},
            {'piece': 'bach_2.mp3', 'time': 0.1, 'ic1': 0, 'ic2': 0.69, 'ic3': 0}
        ])
    ...
    def test_mean_and_std(self, data: pd.DataFrame):
        expected = pd.DataFrame([
            {'piece': 'bach_2.mp3', 'time': 0, ('ic1', 'mean'): 0.0575, ('ic1', 'std'): 0.040233692348578, 
                ('ic2', 'mean'): 0.34, ('ic2', 'std'): 0.22616365755797, ('ic3', 'mean'): 0, ('ic3', 'std'): 0}
        ])
