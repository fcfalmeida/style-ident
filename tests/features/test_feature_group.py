...
class TestFeatureGroup:
    ...
    def data(scope='class'):
        df = pd.DataFrame([
            ...
            {'piece': 'bach_2.mp3', 'time': 0.2, 'c1': 0, 'c2': 0, 'c3': 0, 'c4': 0, 
    ...
    def test_extractor_group(self, data):
        expected = pd.DataFrame([
            {'piece': 'bach_2.mp3', 'time': 0, 'ic1': 0.0873, 'ic2': 0.0814, 'ic3': 0.0717,
                ...
                'chord_maj': 0.006011, 'chord_min': 0.005965, 'chord_dim': 0.004866, 'chord_aug': 0.006651,
                'comp_diff': 0.65, 'comp_std': 0.82148763, 'comp_slope': 0.641384257,
                'comp_entr': 0.92430871434, 'comp_sparse': 0.78985308194, 'comp_flat': 0.7923240272, 'comp_fifth': 0.9294068001},
            {'piece': 'bach_2.mp3', 'time': 0.1, 'ic1': 0.0820, 'ic2': 0.0577, 'ic3': 0.0850, 
                'ic4': 0.1009, 'ic5': 0.0826, 'ic6': 0.0670,
                'chord_maj': 0.008792, 'chord_min': 0.008448, 'chord_dim': 0.005848, 'chord_aug': 0.010998,
                'comp_diff': 0.59, 'comp_std': 0.81760848, 'comp_slope': 0.612694997, 
                'comp_entr': 0.91369479299, 'comp_sparse': 0.78265321994, 'comp_flat': 0.754386555, 'comp_fifth': 0.955902087},
            {'piece': 'bach_2.mp3', 'time': 0.2, 'ic1': 0, 'ic2': 0, 'ic3': 0, 'ic4': 0, 'ic5': 0, 'ic6': 0,
                'chord_maj': 0, 'chord_min': 0, 'chord_dim': 0, 'chord_aug': 0,
                'comp_diff': 0, 'comp_std': 0, 'comp_slope': 0, 'comp_entr': 0, 'comp_sparse': 0, 'comp_flat': 0, 'comp_fifth': 0}
        ])
